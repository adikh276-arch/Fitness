    ...
    <div className="max-w-4xl mx-auto py-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="space-y-8">
          <div>
            <label className="text-sm font-bold text-gray-700 mb-4 block uppercase tracking-wider">How tasty was it?</label>
          ...
          <div>
            <label className="text-sm font-bold text-gray-700 mb-4 block uppercase tracking-wider">How healthy do you think it is?</label>
            <Select value={healthiness} onValueChange={setHealthiness}>
              <SelectTrigger className="h-[60px] rounded-2xl bg-gray-50 border-gray-100 focus:bg-white transition-all text-lg">
                <SelectValue placeholder="Select health level" />
              </SelectTrigger>
              <SelectContent className="rounded-2xl">
                <SelectItem value="Very Healthy">Very Healthy 🥦</SelectItem>
                <SelectItem value="Fairly Healthy">Fairly Healthy 🥗</SelectItem>
                <SelectItem value="Treat but Worth It">Treat but Worth It 🍩</SelectItem>
              </SelectContent>
            </Select>
          </div>

          <div>
            <label className="text-sm font-bold text-gray-700 mb-4 block uppercase tracking-wider">Add a photo (Optional)</label>
              ...
              <label className="cursor-pointer flex flex-col items-center justify-center w-32 h-32 rounded-3xl bg-gray-50 border-2 border-dashed border-gray-200 hover:border-emerald-500 hover:bg-emerald-50 transition-all overflow-hidden group">
                {photo ? (
                  ...
                  <>
                    ...
                    <span className="text-[10px] font-bold text-gray-400 mt-2 uppercase tracking-widest group-hover:text-emerald-500">Upload</span>
                  </>
                )}
                <input type="file" accept="image/*" onChange={handlePhoto} className="hidden" />
              </label>
              <div className="flex-1">
                <p className="text-sm text-gray-500 italic">"We eat with our eyes first! Snap a photo of your masterpiece."</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <div>
            <label className="text-sm font-bold text-gray-700 mb-4 block uppercase tracking-wider">Tag your recipe</label>
