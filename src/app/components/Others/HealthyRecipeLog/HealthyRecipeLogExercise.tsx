...
const HealthyRecipeLogExercise = ({ onBack: onBackToDashboard }: HealthyRecipeLogExerciseProps) => {
  ...
  const getScreenTitle = () => {
    switch (screen) {
      case 1: return "Recipe Log";
      case 2: return "Recipe Details";
      case 3: return "Experience";
      case 4: return "Final Thoughts";
      case 5: return "All Done!";
      default: return "Recipe Log";
    }
  };

  const getScreenSubtitle = () => {
    switch (screen) {
      case 1: return "Save your healthy culinary creations";
      case 2: return "What did you cook today?";
      case 3: return "How did it taste and feel?";
      case 4: return "Reflect on your cooking journey";
      case 5: return "Recipe saved successfully";
      default: return "Track your healthy habits";
    }
  };
            ...
            <div className="flex items-center gap-3 lg:gap-4">
              ...
              <div className="min-w-0">
                <h1 className="text-lg lg:text-xl font-semibold text-gray-900 truncate">
                  {showHistory ? "Recipe History" : getScreenTitle()}
                </h1>
                <p className="text-xs lg:text-sm text-gray-500 truncate">
                  {showHistory ? "Your collection of healthy meals" : getScreenSubtitle()}
                </p>
              </div>
            </div>
          </div>
